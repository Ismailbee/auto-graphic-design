  ...
  <div class="fixed top-0 left-0 z-40 justify-between flex items-center sm:justify-between w-full h-[75px] px-4 py-3  bg-[#f6ebcd] ">
    ...
    <div class="flex items-center justify-center ml-5 transition cursor-pointer sm:hidden"
      ...
      :class="[
        ...
        showHeader ? 'text-brown' : 'text-brown'  // or 'text-brown' if it's defined in Tailwind config
      ]"
    />
    ...
    <div class="relative hidden ml-10 sm:flex  sm:justify-center sm:visible px-4 max-w-[500px]">
      <input 
        type="text"
        placeholder="Search..."
    ...
    <!-- Right Section -->
    <div class="flex justify-end flex-shrink-0 gap-4 mr-7 sm:justify-center">
