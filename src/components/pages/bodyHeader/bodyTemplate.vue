<template>
  ...
  >
    ...
    <ion-icon 
      :icon="labelIcon"
      class="text-lg text-[#ca790f] ml-1 transition-transform duration-500 inline-block transform"
    ...
    <div v-if="isOpen" class="absolute top-[70px] z-10 w-[420px]">
      ...
      <div class="mt-3 bg-white text-[12px] rounded-xl shadow-lg py-3 px-4 text-black relative">
        <ul class="grid grid-cols-4 gap-4">
          ...
          <!-- Column 2 -->
          <div class="w-[95px] border-l pl-3">
          ...
          <!-- Column 3 -->
          <div class="w-[90px] border-l pl-3">
          ...
          <!-- Column 4 -->
          <div class="w-[80px] border-l pl-3">
