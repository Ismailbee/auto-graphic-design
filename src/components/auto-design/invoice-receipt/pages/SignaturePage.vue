  ...
  <div class="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-purple-100 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 p-2 md:p-3">
    <div class="max-w-4xl mx-auto lg:max-w-6xl xl:max-w-7xl">
      ...
      <div class="mb-3">
        <button
          @click="handleBack"
          class="mb-2 hidden md:flex px-2.5 py-1 bg-white dark:bg-slate-800 rounded-lg shadow hover:shadow-md transition-shadow flex items-center gap-1 text-slate-700 dark:text-slate-200 text-[10px]"
        >
...
const loadSignatures = async () => {
  ...
  if (!authenticatedMember.value) {
    ...
    localStorage.setItem('sdp_authenticated_member', JSON.stringify(authenticatedMember.value));
  }
    ...
    try {
      ...
      if (parsedData && typeof parsedData === 'object') {
        ...
        if (!parsedData.branch) {
          ...
          localStorage.setItem('sdp_authenticated_member', JSON.stringify(parsedData));
        }
