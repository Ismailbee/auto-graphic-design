        ...
        <div class="text-center flex-shrink-0" :style="{ marginBottom: '0.02in' }">
          <div class="flex gap-3 items-start justify-center">
            ...
            <div class="flex-shrink-0 flex items-center justify-center">
              <div v-if="!logoDataUrl" class="text-xs text-red-500 border border-red-300 p-1">No Logo</div>
              <img
                v-if="logoDataUrl"
                :src="logoDataUrl"
                alt="Logo"
            ...
            <div style="flex: 1; text-align: center;">
              <h2
                ...
                :style="{ color: colorStyles.accentColor, textTransform: 'uppercase' }"
              >
                {{ organizationName }}
              </h2>
...
export default defineComponent({
  ...
  props: {
    ...
    // Colors – used dynamically in this template
