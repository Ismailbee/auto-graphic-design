          ...
          <div class="flex gap-3 items-start justify-center">
            ...
            <div class="flex-shrink-0 flex items-center justify-center">
              ...
              <img
                ...
                alt="Logo"
                class="object-contain"
                :style="{ height: `${logoHeight}px`, filter: 'grayscale(100%)' }"
            ...
            <div style="flex: 1; text-align: center;">
              ...
              <p
                ...
                style="font-size: 14px !important; font-weight: 700; margin: 2px 0 0 0; padding: 0; line-height: 1.2; color: #000000; text-transform: uppercase; letter-spacing: 0.5px;"
              >
        ...
        >
          ...
          <div class="flex justify-between items-end flex-shrink-0 -mt-2">
            ...
            <div class="flex flex-col items-center justify-end" :style="{ flex: '1 1 auto', maxWidth: '40%' }">
              <div class="border-2 border-black bg-white" :style="{ padding: '0in', minWidth: '1.5in', minHeight: '0.4in', display: 'flex', justifyContent: 'center', alignItems: 'center' }">
...
export default defineComponent({
  ...
  props: {
    ...
    // Colors – accepted but ignored in 1-color template
    colorStyles: { type: Object, default: () => ({ accentColor: '#000000', headerText: '#ffffff' }) },
  ...
  setup(props, { emit, expose }) {
    ...
    // Local writable computed refs for v-model fields
